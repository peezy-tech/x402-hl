...
async function signDeclaredExecutionIntent(paymentRequired, config) {
  ...
  if (declaration && signedIntent.intentHash.toLowerCase() !== declaration.intentHash.toLowerCase()) {
...
async function resolveIntentInput(declaration, paymentRequired, configuredIntent) {
